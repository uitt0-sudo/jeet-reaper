...
import { kolsDisplayData, KOLDisplayData } from "@/config/kol-data";
...
// Convert display data to KOL format
const kolsData: KOL[] = kolsDisplayData.map((kol: KOLDisplayData) => ({
  name: kol.name,
  imageUrl: kol.imageUrl,
  totalFumbled: kol.totalFumbled,
  totalFumbledNum: kol.totalFumbledNum,
  worstFumbleToken: kol.worstFumbleToken,
  worstFumbleDate: kol.worstFumbleDate,
  worstFumbleAmount: kol.worstFumbleAmount,
  worstFumbleAmountNum: kol.worstFumbleAmountNum,
  fumblesTracked: kol.fumblesTracked,
  rank: kol.rank,
}));
